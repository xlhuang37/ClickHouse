...
inline constexpr std::array<ResourceCost, MultiLevelFeedbackQueue::kPriorityLevels - 1> kElasticBandThresholdsNs = {
    static_cast<ResourceCost>(10'000'000),         /// L1: < 10 ms cumulative CPU
    static_cast<ResourceCost>(100'000'000),        /// L2: < 100 ms
    static_cast<ResourceCost>(1'000'000'000),      /// L3: < 1 s
    static_cast<ResourceCost>(10'000'000'000),     /// L4: < 10 s
    static_cast<ResourceCost>(100'000'000'000),    /// L5: < 100 s
    static_cast<ResourceCost>(1'000'000'000'000),  /// L6: < 1000 s
    static_cast<ResourceCost>(10'000'000'000'000), /// L7: < 10000 s
