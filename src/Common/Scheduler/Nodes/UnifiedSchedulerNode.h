...
private:
    ...
    {
        SchedulerNodePtr queue; /// MultiLevelFeedbackQueue node is used if there are no children
    ...
    private:
        void createQueue(EventQueue * event_queue_)
        {
            ...
            queue = std::make_shared<MultiLevelFeedbackQueue>(event_queue_, node_info);
